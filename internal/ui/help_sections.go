	...
	return []helpSection{
		...
		},
		{
			...
			bindings: []helpEntry{
				...
				{"R", "Refresh"},
				{"Tab / Shift+Tab", "Next / previous phase"},
				{"Enter / Space", "Collapse / expand focused phase"},
				{"j/k / Down/Up", "Scroll within focused phase"},
				{"g / G", "Jump to top / bottom of focused phase"},
