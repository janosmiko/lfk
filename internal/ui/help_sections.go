	...
	return []helpSection{
		...
		},
		{
			...
			bindings: []helpEntry{
				...
				{kb.SessionManager, "Session manager (save/switch/delete)"},
				...
				{kb.TasksOverlay, "Scheduler / task queue overlay"},
			},
		},
		{
			title: "Sorting",
		...
		},
		{
			...
			bindings: []helpEntry{
				...
				{"ctrl+x", "Delete selected bookmark (in overlay)"},
				{"alt+x", "Delete all bookmarks (in overlay)"},
			},
		},
		{
			title: "Tabs",
	...
	return append([]helpSection{
		...
		},
		{
			...
			bindings: []helpEntry{
				...
				{"p", "Profile picker (traefik-json, nginx, envoy, ...)"},
				{",", "Column picker: show/hide and reorder columns"},
