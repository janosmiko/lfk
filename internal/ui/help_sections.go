	...
	return []helpSection{
		...
		},
		{
			...
			bindings: []helpEntry{
				...
				{kb.Fullscreen, "Cycle layout: hide sidebar / fullscreen / restore (dashboards toggle fullscreen)"},
		...
		},
		{
			...
			bindings: []helpEntry{
				...
				{"", "Sessions: :session save <name>, :session delete <name>, :sessions / " + kb.SessionManager + " (picker: enter=switch, s=save-as, d=delete, /=filter)"},
		...
		},
		{
			...
			bindings: []helpEntry{
				{"", "Launched from the action menu (\"Log Top\", quick-key T) or by pressing " + kb.LogTop + " in the open log viewer. Aggregates logs by parsed attributes. Columns auto-fit the terminal width (wider = more columns, up to all of REQ, REQ/s, ERR%, P50/P95/P99, ERR, 4XX, 5XX, AVG, MAX, %); `,` toggles/reorders columns explicitly."},
				{"j/k", "Navigate rows"},
