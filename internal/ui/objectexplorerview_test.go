...
func TestRenderObjectExplorerView_InlineValuesAndPreview(t *testing.T) {
	out := RenderObjectExplorerView(
		...
		"Resource: Chore/chore-1",
		[]string{"status"},
		"phase: Succeeded\nname: build\n",
		0, "", "hint", 120, 30,
	)
	assert.Contains(t, out, "Resource: Chore/chore-1")
	...
	// Breadcrumb keeps the path segment.
	assert.Contains(t, out, "status")
}

func TestRenderObjectExplorerView_NoDrillHint(t *testing.T) {
	out := RenderObjectExplorerView(
		sampleObjectFields(), 2, 0, "Resource: x", nil,
		"a: 1\n", 0, "", "hint", 120, 30,
	)
...
func TestRenderObjectExplorerView_EmptyPreview(t *testing.T) {
	out := RenderObjectExplorerView(
		sampleObjectFields(), 0, 0, "Resource: x", nil,
		"", 0, "", "hint", 120, 30,
	)
...
func TestRenderObjectExplorerView_NoFields(t *testing.T) {
	out := RenderObjectExplorerView(nil, 0, 0, "Resource: x", nil, "", 0, "", "hint", 80, 20)
