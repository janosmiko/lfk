...
func ApplyTheme(t Theme) {
	...
	RowTintProgressingFg = lipgloss.NewStyle().Foreground(lipgloss.Color(t.Warning)).Background(baseBg)
	...
	RowTintProgressingBg = lipgloss.NewStyle().Foreground(lipgloss.Color(t.Text)).
		Background(lipgloss.Color(blendHexToward(t.Base, t.Warning, rowTintBgBlend)))
	...
	// Purple background (vs warning-yellow for regular matches) and underline
	// together make the current match visually unambiguous across themes.
