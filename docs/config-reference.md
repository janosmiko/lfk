...
| `security.sources.<name>` | bool | `true` | Enable/disable individual sources (`heuristic`, `advisor`, `trivy`, `kyverno`, `kubescape`, `falco`, `gatekeeper`). A source omitted from the map stays enabled. |
